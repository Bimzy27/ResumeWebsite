...
// The heavy half of the hero background: TresCanvas, lights, camera, and the
// desk scene. Split out of Background3DScene.vue so that everything touching
// three/@tresjs/core lives in a lazily loaded chunk - Background3DScene only
// async-imports this component once its WebGL/viewport gates pass, keeping
// Three.js off the critical path entirely (and never downloaded on phones).
