# Spec: bookshelf-section

## ADDED Requirements

### Requirement: Bookshelf section placement
The site SHALL present a Bookshelf section underneath the Device section, showing the books Branden has read.

#### Scenario: Section order
- **WHEN** the site is loaded
- **THEN** the Bookshelf section renders after the Device section and before the contact section
